          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Welcome {userName}! Manage your strategic relationships and drive business growth</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border-white/20 mb-8">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center">
              Welcome to Your Strategic Accounts CRM {userName}!
            </CardTitle>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-gray-600 text-lg">
              Your comprehensive platform for managing strategic business relationships, 
              tracking interactions, and driving revenue growth.
            </p>
