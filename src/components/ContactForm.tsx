...
export default function ContactForm({ contact, accounts, onSave, onCancel }: ContactFormProps) {
  ...
  useEffect(() => {
    const element = autocompleteElRef.current?.querySelector("gmp-place-autocomplete") as HTMLElement | null;
    if (element && isLoaded) {
      ...
      element.addEventListener("gmp-place-change", handlePlaceChange);
      return () => {
        element.removeEventListener("gmp-place-change", handlePlaceChange);
      };
    }
            ...
            <div>
              ...
              {isLoaded ? (
                <div ref={autocompleteElRef}>
                  <gmp-place-autocomplete id="shipping-address-autocomplete"></gmp-place-autocomplete>
                </div>
              ) : (
                <Input
