  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Rest of the form continues with Contact Information, Ways of Working, etc. - keeping the rest unchanged */}
        {/* Due to character limits, I'm showing only the changed sections. The rest of the form remains the same */}
