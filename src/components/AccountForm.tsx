    ...
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <h4 className="font-semibold mb-3 text-sm text-gray-700">Account/Capabilities</h4>
      ...
      {/* Rest of the form continues with JBP, Additional Information, Banner/Buying Offices, and Contacts sections... */}
      {/* The remaining code is identical to the original file from line 1982 onwards */}
    </form>
  );
}