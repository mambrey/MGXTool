...
export default function AccountForm({ account, contacts = [], onSave, onCancel }: AccountFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      {/* BUSINESS STRATEGY - SEPARATE CARD */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">
            <Target className="w-4 h-4 sm:w-5 sm:h-5" />
      ...
      {/* Continue with rest of the form - PLANOGRAM INFORMATION, JBP, Additional Information, Banner/Buying Offices, Contacts, and Submit buttons remain the same */}
      {/* For brevity, I'm truncating here since the rest of the file remains unchanged */}
