...
This guide will walk you through setting up Azure AD App Registration to enable real SharePoint file uploads in the Diageo AccountIQ Dashboard.
...
3. **Register New Application**
   ...
   - Fill in the registration form:
     - **Name**: `Diageo AccountIQ - SharePoint Integration`
