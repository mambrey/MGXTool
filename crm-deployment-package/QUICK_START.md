# Diageo AccountIQ - Azure VM Deployment Package

**Quick Start Guide for Deploying to Azure Virtual Machine**

This package contains everything you need to deploy your Diageo AccountIQ to an Azure VM without using GitHub. All files transfer directly from your local machine to the Azure VM.
...
You should see your Diageo AccountIQ login page!
...
This package contains everything needed to deploy your Diageo AccountIQ to Azure VM.
